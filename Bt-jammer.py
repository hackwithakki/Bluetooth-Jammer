...
def printLogo():
    ...
    print('+-------------------------------------------------------------------------+ ')
    print('|  _ __ ___   __ _  __| | ___   | |__  _   _           Hackwithakki       | ')
    print("| | '_ ` _ \ / _` |/ _` |/ _ \  | '_ \| | | |          Hackwithakki       | ")
    print('| | | | | | | (_| | (_| |  __/  | |_) | |_| |          Hackwithakki       | ')
    print('| |_| |_| |_|\__,_|\__,_|\___|  |_.__/ \__, |          Hackwithakki       | ')
    print('|                                      |___/           Hackwithakki       | ')
    print('+-------------------------------------------------------------------------+ ')
    print('\x1b[0m')
